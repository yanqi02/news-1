 ...
 * 
 */
@WebServiceClient(name = "FunctionService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:8080/function?WSDL")
    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://web/", "FunctionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/function?WSDL");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://web/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web/", "FunctionPort"), Function.class, features);
    }
