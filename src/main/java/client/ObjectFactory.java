...
public class ObjectFactory {
    ...
    private final static QName _TransWords_QNAME = new QName("http://web/", "transWords");
    private final static QName _TransWordsResponse_QNAME = new QName("http://web/", "transWordsResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "transWords")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web/", name = "transWordsResponse")
